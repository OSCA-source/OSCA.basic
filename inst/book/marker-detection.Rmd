...
```{r pbmc-scored-markers-again, fig.height=10, fig.width=8, fig.cap="Distribution of expression values across clusters for the top potential marker genes from cluster 4 in the PBMC dataset."}
...
```{r}
demo <- m.out[["1"]] 
demo[order(demo$median.logFC.cohen, decreasing=TRUE),1:4]
```
