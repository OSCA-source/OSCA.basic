...
In addition, the graph can be used to generate detailed diagnostics on the behavior of the graph-based clustering (`r link("graph-diagnostics", "OSCA.advanced")`).
